package com.github.empyrosx.flagquiz;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (preferencesChanged) {
            MainActivityFragment quizFragment = getMainActivityFragment();
    ...
    private OnSharedPreferenceChangeListener initPreferencesChangeListener() {
    ...
    private MainActivityFragment getMainActivityFragment() {
        return (MainActivityFragment) getSupportFragmentManager().findFragmentById(R.id.quizFragment);
    }
